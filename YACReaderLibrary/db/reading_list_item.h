...
{
public:
    ReadingListItem(const QList<QVariant> &data, ReadingListItem *parent = nullptr, bool folder = false, bool smartList = false, bool importedCbl = false);
    QIcon getIcon() const override;
