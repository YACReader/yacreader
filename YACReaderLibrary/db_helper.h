...
public:
    ...
    static bool isImportedCblReadingList(qulonglong readingListId, QSqlDatabase &db);
    static int countMissingReadingListEntries(QSqlDatabase &db, qulonglong readingListId);
