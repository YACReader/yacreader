...
public:
    ...
    bool getUseSoftwareGoToFlow() { return settings->value(USE_SOFTWARE_GO_TO_FLOW, false).toBool(); }
    void setUseSoftwareGoToFlow(bool b) { settings->setValue(USE_SOFTWARE_GO_TO_FLOW, b); }
